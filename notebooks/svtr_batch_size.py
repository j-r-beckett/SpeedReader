...
def _(df):
    ...
    mo.vstack([
        mo.md("""
## SVTRv2 Batch Size Analysis

Does batch size affect per-image inference duration?

SVTRv2 has much smaller inputs (160x48x3 = 23K values) compared to DbNet (640x640x3 = 1.2M values).
Smaller inputs fit in cache, so batching might amortize model weight loading overhead.
        """),
        fig,
        mo.md("### Raw Data"),
