...
public class ImprovedPostProcessingTests_dirty
{
    private readonly ITestOutputHelper _outputHelper;
    private readonly TestLogger<ImprovedPostProcessingTests_dirty> _logger;
    private readonly FileSystemUrlPublisher<ImprovedPostProcessingTests_dirty> _urlPublisher;

    public ImprovedPostProcessingTests_dirty(ITestOutputHelper outputHelper)
    {
        _outputHelper = outputHelper;
        _logger = new TestLogger<ImprovedPostProcessingTests_dirty>(outputHelper);
        var outputDirectory = System.IO.Path.Combine(Directory.GetCurrentDirectory(), "out", "debug");
        _urlPublisher = new FileSystemUrlPublisher<ImprovedPostProcessingTests_dirty>(outputDirectory, _logger);
    }
