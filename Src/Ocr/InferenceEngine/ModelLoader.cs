...
public class ModelLoader
{
    ...
    public byte[] LoadModel(Model model, Quantization quantization)
    {
        ...
        {
            (Model.DbNet, Quantization.Fp32) => "dbnet_resnet18_fpnc_1200e_icdar2015.end2end.onnx",
            (Model.DbNet, Quantization.Int8) => "dbnet_resnet18_fpnc_1200e_icdar2015.end2end_int8.onnx",
            (Model.Svtr, Quantization.Fp32) => "svtrv2_base_ctc.end2end.onnx",
