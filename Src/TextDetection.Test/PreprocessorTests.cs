...
public class PreprocessorTests
{
    ...
    {
        // Replicate the scaling logic from Preprocessor.CalculateDimensions for individual image
        ...
        (int width, int height)[] originalDimensions, int modelWidth, int modelHeight)
    {
        ...
        var calculatedDimensions = Preprocessor.CalculateDimensions(images);
